...
class ReviewPenelitianController extends Controller
{
    public function index()
    {
        ...
        $skemas = DB::table('reviews')
            ->leftJoin('penelitians', 'reviews.usulan_id', '=', 'penelitians.id')
            ->leftJoin('ref_skemas', 'ref_skemas.id', '=', 'penelitians.skema_id')
            ->where('penelitians.tahun', date('Y'))
    ...
    public function edit($usulan_id)
    {
        ...
        return view('reviews.penelitians.edit', compact('penelitian', 'questions', 'jawabans', 'review'));
    ...
    public function update(Request $request, $usulan_id)
    {
        ...
        return redirect()->route('review-penelitians.index');
    }
