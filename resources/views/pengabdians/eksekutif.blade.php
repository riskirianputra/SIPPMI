...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <ul class="step-progressbar">
                <li class="step-progressbar__item step-progressbar__item--complete"><a href="{{ route('pengabdians.edit', [$pengabdian->id]) }}">Informasi Dasar</a></li>
    ...
    <div class="card">
        ...
        <div class="card-footer">
            <form id='form_eksekutif' action="{{ route('pengabdians.storeeksekutif', $pengabdian->id) }}" method="POST"
                  style="display: none">
                @csrf
                <input type="text" name="ringkasan_eksekutif"/>
            </form>

            <a href="{{ route('pengabdians.edit', $pengabdian) }}" class="btn btn-danger">Kembali</a>
