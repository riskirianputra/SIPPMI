...
@section('content')
        ...
        <div class="col-md-12">
            <ul class="step-progressbar">
                <li class="step-progressbar__item step-progressbar__item--active">
                    <a href="{{ route('penelitians.create') }}">Makalah</a>
                </li>
                <li class="step-progressbar__item">Penulis</li>
    ...
    <div class="card">
        {{ html()->modelForm('makalah', 'POST', route('pemakalahs.update', [$makalah->id]))->acceptsFiles()->open() }}
