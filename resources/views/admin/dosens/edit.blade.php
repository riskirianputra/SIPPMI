                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("admin.dosens.update", [$dosen->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('nama') ? 'is-invalid' : '' }}" type="text" name="nama" id="nama" value="{{ old('nama', $dosen->nama) }}" required>
                            @if($errors->has('nama'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="text" name="email" id="email" value="{{ old('email', $dosen->email) }}" required>
                            @if($errors->has('email'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('email') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('prodi') ? 'is-invalid' : '' }}" name="prodi_id" id="prodi_id">
                                @foreach($prodis as $id => $prodi)
                                    <option value="{{ $id }}" {{ ($dosen->prodi ? $dosen->prodi->id : old('prodi_id')) == $id ? 'selected' : '' }}>{{ $prodi }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control {{ $errors->has('jabatan_fungsional') ? 'is-invalid' : '' }}" name="jabatan_fungsional" id="jabatan_fungsional">
                                ...
                                @foreach(App\Dosen::JABATAN_FUNGSIONAL_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('jabatan_fungsional', $dosen->jabatan_fungsional) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" type="text" name="status" id="status" value="{{ old('status', $dosen->status) }}">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Dosen::JENIS_KELAMIN_RADIO as $key => $label)
                                <div class="form-check {{ $errors->has('jenis_kelamin') ? 'is-invalid' : '' }}">
                                    <input class="form-check-input" type="radio" id="jenis_kelamin_{{ $key }}" name="jenis_kelamin" value="{{ $key }}" {{ old('jenis_kelamin', $dosen->jenis_kelamin) === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control {{ $errors->has('pangkat_golongan') ? 'is-invalid' : '' }}" name="pangkat_golongan" id="pangkat_golongan">
                                ...
                                @foreach(App\Dosen::PANGKAT_GOLONGAN_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('pangkat_golongan', $dosen->pangkat_golongan) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('telepon') ? 'is-invalid' : '' }}" type="text" name="telepon" id="telepon" value="{{ old('telepon', $dosen->telepon) }}">
