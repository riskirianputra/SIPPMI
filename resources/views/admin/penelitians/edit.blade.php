    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.penelitians.update", [$penelitian->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('judul') ? 'is-invalid' : '' }}" type="text" name="judul" id="judul" value="{{ old('judul', $penelitian->judul) }}" required>
                @if($errors->has('judul'))
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('skema') ? 'is-invalid' : '' }}" name="skema_id" id="skema_id">
                    @foreach($skemas as $id => $skema)
                        <option value="{{ $id }}" {{ ($penelitian->skema ? $penelitian->skema->id : old('skema_id')) == $id ? 'selected' : '' }}>{{ $skema }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('kode_rumpun') ? 'is-invalid' : '' }}" name="kode_rumpun_id" id="kode_rumpun_id">
                    @foreach($kode_rumpuns as $id => $kode_rumpun)
                        <option value="{{ $id }}" {{ ($penelitian->kode_rumpun ? $penelitian->kode_rumpun->id : old('kode_rumpun_id')) == $id ? 'selected' : '' }}>{{ $kode_rumpun }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('prodi') ? 'is-invalid' : '' }}" name="prodi_id" id="prodi_id" required>
                    @foreach($prodis as $id => $prodi)
                        <option value="{{ $id }}" {{ ($penelitian->prodi ? $penelitian->prodi->id : old('prodi_id')) == $id ? 'selected' : '' }}>{{ $prodi }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('tahapan') ? 'is-invalid' : '' }}" name="tahapan_id" id="tahapan_id">
                    @foreach($tahapans as $id => $tahapan)
                        <option value="{{ $id }}" {{ ($penelitian->tahapan ? $penelitian->tahapan->id : old('tahapan_id')) == $id ? 'selected' : '' }}>{{ $tahapan }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('ringkasan_eksekutif') ? 'is-invalid' : '' }}" name="ringkasan_eksekutif" id="ringkasan_eksekutif">{{ old('ringkasan_eksekutif', $penelitian->ringkasan_eksekutif) }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('multi_tahun') ? 'is-invalid' : '' }}" name="multi_tahun" id="multi_tahun">
                    ...
                    @foreach(App\Penelitian::MULTI_TAHUN_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('multi_tahun', $penelitian->multi_tahun) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tahun_ke') ? 'is-invalid' : '' }}" type="number" name="tahun_ke" id="tahun_ke" value="{{ old('tahun_ke', $penelitian->tahun_ke) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('biaya') ? 'is-invalid' : '' }}" type="number" name="biaya" id="biaya" value="{{ old('biaya', $penelitian->biaya) }}" step="0.01">
                @if($errors->has('biaya'))
                    <div class="invalid-feedback">
                        {{ $errors->first('biaya') }}
                    </div>
