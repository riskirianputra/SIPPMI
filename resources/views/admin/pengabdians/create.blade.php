    ...
    <div class="row">
        <div class="col-sm-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("admin.pengabdians.store") }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('mitra_pengabdian') ? 'is-invalid' : '' }}" type="text" name="mitra_pengabdian" id="mitra_pengabdian" value="{{ old('mitra_pengabdian', '') }}">
