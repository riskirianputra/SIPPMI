        ...
        <div class="col-sm-8">
            <div class="card">
                <div class="card-header font-weight-bold">
                    {{ trans('global.create') }} {{ trans('cruds.refSkema.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("admin.ref-skemas.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            ...
                            <select class="form-control {{ $errors->has('jenis_usulan') ? 'is-invalid' : '' }}" name="jenis_usulan" id="jenis_usulan">
                                ...
                                @foreach(App\RefSkema::JENIS_USULAN_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('jenis_usulan', 'P') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('jangka_waktu') ? 'is-invalid' : '' }}" type="number" name="jangka_waktu" id="jangka_waktu" value="{{ old('jangka_waktu') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('biaya_minimal') ? 'is-invalid' : '' }}" type="number" name="biaya_minimal" id="biaya_minimal" value="{{ old('biaya_minimal') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('biaya_maksimal') ? 'is-invalid' : '' }}" type="number" name="biaya_maksimal" id="biaya_maksimal" value="{{ old('biaya_maksimal') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('anggota_min') ? 'is-invalid' : '' }}" type="text" name="anggota_min" id="anggota_min" value="{{ old('anggota_min', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('anggota_max') ? 'is-invalid' : '' }}" type="text" name="anggota_max" id="anggota_max" value="{{ old('anggota_max', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('mahasiswa_min') ? 'is-invalid' : '' }}" type="number" name="mahasiswa_min" id="mahasiswa_min" value="{{ old('mahasiswa_min', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('mahasiswa_max') ? 'is-invalid' : '' }}" type="number" name="mahasiswa_max" id="mahasiswa_max" value="{{ old('mahasiswa_max', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date {{ $errors->has('tanggal_mulai') ? 'is-invalid' : '' }}" type="date" name="tanggal_mulai" id="tanggal_mulai" value="{{ old('tanggal_mulai') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date {{ $errors->has('tanggal_selesai') ? 'is-invalid' : '' }}" type="date" name="tanggal_selesai" id="tanggal_selesai" value="{{ old('tanggal_selesai') }}">
