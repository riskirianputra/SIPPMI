                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("admin.prodis.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('kode_dikti') ? 'is-invalid' : '' }}" type="text" name="kode_dikti" id="kode_dikti" value="{{ old('kode_dikti', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('akreditasi') ? 'is-invalid' : '' }}" type="text" name="akreditasi" id="akreditasi" value="{{ old('akreditasi', '') }}">
