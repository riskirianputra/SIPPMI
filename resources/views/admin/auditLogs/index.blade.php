...
@section('breadcrumb')
    {!! cui_breadcrumb([
        ...
        'Audit Log' => route('admin.audit-logs.index'),
        'Index' => '#'
    ]) !!}
@stop
@section('content')
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-AuditLog" style="width: 100%">
            <thead>
                <tr>
                    <th width="10">
