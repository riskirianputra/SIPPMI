        ...
        <div class="col-sm-8">
            <div class="card">
                <div class="card-header font-weight-bold">
                    {{ trans('global.create') }} {{ trans('cruds.penelitianBiaya.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("admin.penelitian-biayas.store") }}" enctype="multipart/form-data">
                        @csrf
                        <div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('biaya_skema') ? 'is-invalid' : '' }}" name="biaya_skema_id" id="biaya_skema_id">
                                @foreach($biaya_skemas as $id => $biaya_skema)
                                    <option value="{{ $id }}" {{ old('biaya_skema_id') == $id ? 'selected' : '' }}>{{ $biaya_skema }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('jumlah_final') ? 'is-invalid' : '' }}" type="number" name="jumlah_final" id="jumlah_final" value="{{ old('jumlah_final') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('satuan') ? 'is-invalid' : '' }}" type="text" name="satuan" id="satuan" value="{{ old('satuan', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('harga_satuan') ? 'is-invalid' : '' }}" type="number" name="harga_satuan" id="harga_satuan" value="{{ old('harga_satuan') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('harga_satuan_final') ? 'is-invalid' : '' }}" type="number" name="harga_satuan_final" id="harga_satuan_final" value="{{ old('harga_satuan_final') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control {{ $errors->has('justifikasi') ? 'is-invalid' : '' }}" name="justifikasi" id="justifikasi">{{ old('justifikasi') }}</textarea>
