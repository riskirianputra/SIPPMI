...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-BiayaSkema">
            <thead>
                <tr>
                    <th width="10">
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.biaya-skemas.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'biaya_nama', name: 'biaya.nama' },
{ data: 'persen_max', name: 'persen_max' },
{ data: 'persen_min', name: 'persen_min' },
{ data: 'actions', name: '{{ trans('global.actions') }}' }
    ],
    order: [[ 1, 'desc' ]],
    pageLength: 100,
  };
  $('.datatable-BiayaSkema').DataTable(dtOverrideGlobals);
